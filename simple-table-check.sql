-- Script SIMPLES e CORRIGIDO para verificar tabelas do Supabase
...
-- ===== 3. CONTAR REGISTROS (VERSÃO SIMPLES) =====
SELECT 
...
-- ===== 4. VERIFICAR TABELAS ESPECÍFICAS =====
...
SELECT 
    'FIM' as categoria,
    'Script executado em: ' || NOW() as timestamp,
