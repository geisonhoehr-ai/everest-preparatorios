-- ========================================
-- SCRIPT COMPLETO PARA MIGRAR QUIZZES
-- ========================================
...
-- 2. MIGRAR QUIZZES (COM TODAS AS COLUNAS NECESSÁRIAS)
-- Acentuação Gráfica
INSERT INTO "public"."quizzes" (topic_id, title, description, duration_minutes, created_by_user_id)
SELECT 
...
-- 3. MIGRAR QUESTÕES DE QUIZ (COM TODAS AS COLUNAS NECESSÁRIAS)
-- Questões para Acentuação Gráfica
INSERT INTO "public"."quiz_questions" (quiz_id, topic_id, question_text, question_type, options, correct_answer, explanation, points)
SELECT 
...
JOIN "public"."topics" t ON qq.topic_id = t.id
