-- Script para implementar sistema completo de roles no Supabase
...
RAISE NOTICE '✅ Sistema de roles implementado com sucesso!';
RAISE NOTICE '📋 Tabela user_roles criada e populada';
RAISE NOTICE '🔧 Trigger para novos usuários configurado';
RAISE NOTICE '👥 Usuários de teste inseridos';
