...
async function fixForeignKeyConstraint() {
  try {
    console.log('🔧 [FIX] Resolvendo problema de chave estrangeira...');
...
async function checkConstraintStatus() {
  try {
    ...
    const otherTables = ['user_roles', 'flashcards', 'quizzes', 'redacoes', 'provas'];
...
module.exports = { fixForeignKeyConstraint, checkConstraintStatus };
