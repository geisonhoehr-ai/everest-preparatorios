...
interface SidebarNavProps extends React.HTMLAttributes<HTMLElement> {
  ...
  collapsed?: boolean
  onItemClick?: () => void // Callback para fechar menu mobile
}

export function SidebarNav({ className, items, collapsed = false, onItemClick, ...props }: SidebarNavProps) {
  ...
  const handleItemClick = () => {
    // Fechar menu mobile se callback fornecido
    if (onItemClick) {
      onItemClick()
    }
  }
