-- Script para recriar todo o sistema de autenticação do zero (SEM DADOS DE TESTE)
...
-- ========================================
-- PASSO 10: TESTAR FUNÇÕES
-- ========================================

-- Testar função get_user_role com NULL (deve retornar 'student')
SELECT 
    'TESTE FUNÇÕES' as etapa,
    get_user_role(NULL) as default_role,
    is_admin(NULL) as is_admin_test,
    is_teacher(NULL) as is_teacher_test;
...
SELECT 
    ...
    'Sem dados de teste (evita FK errors)' as test_data_status; 