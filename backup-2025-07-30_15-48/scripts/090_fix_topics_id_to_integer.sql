-- Script para converter topics.id de text para integer
-- Execute este script no SQL Editor do Supabase

-- ========================================
-- CONVERSÃO DE TOPICS.ID PARA INTEGER
-- ========================================
...
-- 2. Verificar dados atuais da tabela topics
SELECT 
...
-- 3. Verificar se há IDs não numéricos
SELECT 
...
-- 5. Criar nova tabela topics com estrutura correta
...
-- 6. Inserir dados limpos na nova tabela
...
-- 9. Dropar tabela antiga e renomear nova
DROP TABLE topics;
ALTER TABLE topics_new RENAME TO topics;

-- 10. Recriar foreign keys com a nova tabela
