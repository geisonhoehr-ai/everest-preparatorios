...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // SOLUÇÃO TEMPORÁRIA: Bypass de autenticação para desenvolvimento
      if (email === "aluno@teste.com" && password === "123456") {
        // Simular login bem-sucedido
        console.log("✅ Login simulado para aluno@teste.com")
        router.push("/dashboard")
        return
      }
      ...
      if (email === "admin@teste.com" && password === "123456") {
        // Simular login bem-sucedido
        console.log("✅ Login simulado para admin@teste.com")
        router.push("/dashboard")
        return
      }
      
      if (email === "professor@teste.com" && password === "123456") {
        // Simular login bem-sucedido
        console.log("✅ Login simulado para professor@teste.com")
        router.push("/dashboard")
        return
      }
