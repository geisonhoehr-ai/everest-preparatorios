...
async function createEssentialData() {
  console.log('🔧 Criando dados essenciais para a página de membros...')
  
  try {
    // 1. Criar classes de exemplo
    console.log('\n🏫 1. Criando classes de exemplo...')
    
    const classes = [
      { name: 'Turma A - Manhã', description: 'Turma da manhã', max_students: 30 },
      { name: 'Turma B - Tarde', description: 'Turma da tarde', max_students: 25 },
      { name: 'Turma C - Noite', description: 'Turma da noite', max_students: 20 }
    ]
