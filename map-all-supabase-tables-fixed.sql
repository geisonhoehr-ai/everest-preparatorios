-- Script CORRIGIDO para mapear todas as tabelas do Supabase
...
-- 4. Mapear todas as colunas de todas as tabelas do schema public
SELECT 
...
-- 5. Mapear colunas das tabelas do schema auth
SELECT 
...
-- 6. Mapear colunas das tabelas do schema storage
SELECT 
...
-- 7. Mapear todas as foreign keys
SELECT 
...
-- 9. Mapear todas as políticas RLS
SELECT 
...
-- 10. Contar registros em cada tabela do schema public (CORRIGIDO)
SELECT 
...
-- 11. Tamanho das tabelas (CORRIGIDO)
SELECT 
...
-- 13. Focar nas tabelas principais do projeto
SELECT 
...
-- 14. Verificar tabelas órfãs (sem registros)
SELECT 
...
-- 15. Verificar tabelas com muitos registros mortos
SELECT 
