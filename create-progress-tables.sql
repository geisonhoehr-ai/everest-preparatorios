-- Criar tabelas de progresso e ranking
...
INSERT INTO user_gamification_stats (user_uuid, total_xp, level, streak_days, flashcards_studied, quizzes_completed, correct_answers, total_answers)
SELECT 
  id,
  0,
  1,
...
INSERT INTO user_rankings (user_id, total_score, rank_position)
SELECT 
  id,
  0,
  999999
