-- ========================================
-- SCRIPT CORRIGIDO PARA MIGRAR QUIZZES COM QUESTION_TYPE
-- ========================================
...
-- 3. MIGRAR QUESTÕES DE QUIZ (COM TOPIC_ID E QUESTION_TYPE)
-- Questões para Acentuação Gráfica
INSERT INTO "public"."quiz_questions" (quiz_id, topic_id, question_type, question_text, options, correct_answer, explanation)
SELECT 
