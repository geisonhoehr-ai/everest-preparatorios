-- =====================================================
-- SCRIPT CORRIGIDO PARA POPULAR FLASHCARDS
...
FROM "public"."users" 
WHERE email = 'admin@teste.com' AND role = 'administrator'
  AND NOT EXISTS (SELECT 1 FROM "public"."subjects" WHERE name = 'Português');
