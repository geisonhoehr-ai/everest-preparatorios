-- ========================================
-- SCRIPT CORRIGIDO PARA MIGRAR QUIZZES COM TOPIC_ID
-- ========================================
...
-- 3. MIGRAR QUESTÕES DE QUIZ (COM TOPIC_ID)
-- Questões para Acentuação Gráfica
INSERT INTO "public"."quiz_questions" (quiz_id, topic_id, question_text, options, correct_answer, explanation)
SELECT 
