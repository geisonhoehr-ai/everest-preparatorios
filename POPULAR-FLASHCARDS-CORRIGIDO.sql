-- =====================================================
-- SCRIPT PARA POPULAR FLASHCARDS - VERSÃO CORRIGIDA
-- =====================================================

-- Primeiro, vamos inserir as matérias (subjects) - SEM ON CONFLICT
...
WHERE NOT EXISTS (
    SELECT 1 FROM "public"."subjects" WHERE name = 'Português'
);

-- Inserir tópicos (topics) para Português - SEM ON CONFLICT
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    ...
    WHERE t2.subject_id = s.id AND t2.name = 'Fonética e Fonologia'
  );
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."topics" t2 
    WHERE t2.subject_id = s.id AND t2.name = 'Ortografia'
  );
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."topics" t2 
    WHERE t2.subject_id = s.id AND t2.name = 'Acentuação Gráfica'
  );
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."topics" t2 
    WHERE t2.subject_id = s.id AND t2.name = 'Morfologia - Classes de Palavras'
  );
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."topics" t2 
    WHERE t2.subject_id = s.id AND t2.name = 'Sintaxe - Termos Essenciais'
  );
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."topics" t2 
    WHERE t2.subject_id = s.id AND t2.name = 'Sintaxe - Termos Integrantes'
  );
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."topics" t2 
    WHERE t2.subject_id = s.id AND t2.name = 'Sintaxe - Termos Acessórios'
  );
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."topics" t2 
    WHERE t2.subject_id = s.id AND t2.name = 'Sintaxe - Período Composto'
  );
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."topics" t2 
    WHERE t2.subject_id = s.id AND t2.name = 'Concordância'
  );
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."topics" t2 
    WHERE t2.subject_id = s.id AND t2.name = 'Regência'
  );
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."topics" t2 
    WHERE t2.subject_id = s.id AND t2.name = 'Crase'
  );
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."topics" t2 
    WHERE t2.subject_id = s.id AND t2.name = 'Colocação Pronominal'
  );
...
WHERE s.name = 'Português' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."topics" t2 
    WHERE t2.subject_id = s.id AND t2.name = 'Semântica e Estilística'
  );

-- Agora vamos inserir os flashcards - SEM ON CONFLICT
...
WHERE t.name = 'Fonética e Fonologia' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    ...
    WHERE f2.topic_id = t.id AND f2.question = 'O que é um fonema?'
  );
...
WHERE t.name = 'Fonética e Fonologia' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'O que é um ditongo?'
  );
...
WHERE t.name = 'Fonética e Fonologia' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'O que é um hiato?'
  );
...
WHERE t.name = 'Fonética e Fonologia' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'O que é um tritongo?'
  );
...
WHERE t.name = 'Fonética e Fonologia' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'O que é um dígrafo?'
  );
...
WHERE t.name = 'Ortografia' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'Qual a diferença entre ''mas'' e ''mais''?'
  );
...
WHERE t.name = 'Ortografia' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'Quando usar ''por que'' separado e sem acento?'
  );
...
WHERE t.name = 'Ortografia' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'Quando usar ''porquê'' junto e com acento?'
  );
...
WHERE t.name = 'Ortografia' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'Quando usar ''sessão'', ''seção'' e ''cessão''?'
  );
...
WHERE t.name = 'Ortografia' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'Qual a diferença entre ''onde'' e ''aonde''?'
  );
...
WHERE t.name = 'Acentuação Gráfica' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'Quando acentuar oxítonas?'
  );
...
WHERE t.name = 'Acentuação Gráfica' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'Quando acentuar paroxítonas?'
  );
...
WHERE t.name = 'Acentuação Gráfica' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'Quando acentuar proparoxítonas?'
  );
...
WHERE t.name = 'Acentuação Gráfica' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'Qual a regra para acentuar ''saúde''?'
  );
...
WHERE t.name = 'Acentuação Gráfica' AND u.email = 'admin@teste.com'
  AND NOT EXISTS (
    SELECT 1 FROM "public"."flashcards" f2 
    WHERE f2.topic_id = t.id AND f2.question = 'A palavra ''heroico'' tem acento?'
  );
