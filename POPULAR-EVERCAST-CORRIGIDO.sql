-- ========================================
-- POPULAR DADOS DE EXEMPLO PARA O EVERCAST (CORRIGIDO)
-- ========================================
...
-- 2. CRIAR CURSOS DE ÁUDIO DE EXEMPLO (SEM created_by_user_id)
INSERT INTO "public"."audio_courses" (name, description)
SELECT 
...
-- 3. CRIAR MÓDULOS PARA OS CURSOS (SEM created_by_user_id)
-- Módulos para Português para Concursos
INSERT INTO "public"."audio_modules" (name, description, course_id)
SELECT 
...
-- 4. CRIAR AULAS DE EXEMPLO (SEM created_by_user_id)
-- Aulas para Gramática Fundamental
INSERT INTO "public"."audio_lessons" (title, description, module_id, audio_url, duration)
SELECT 
